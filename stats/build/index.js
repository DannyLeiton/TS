...
const RefereeAnalysis_1 = require("./analyzers/RefereeAnalysis");
...
const matchReader = MatchReader_1.MatchReader.fromCsv(filename); // Now using a static method with the compose MatchReader
matchReader.load();
